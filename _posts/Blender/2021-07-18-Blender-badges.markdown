...
layout: post
title:  포켓몬 1~2세대 뱃지들
date:   2021-07-18 12:40:16 +0900
categories: Blender
---

# 1 ~ 2 세대 뱃지들

일단 완성도 다 했고 쉐이딩도 다 끝났었는데 애니메이션을 찍어보니 그림자가 이상해서 이걸 해결하느라 시간이 더 오래 걸렸다.. 결국 완벽하게도 해결은 못했다. 투톤 쉐이더를 쓰다보니 평평한 면에서 그림자 질때 색깔과 빛을 받을때의 색깔로 변환이 너무 갑작스럽게 일어나서 이걸 좀 완화시키는 정도로 끝났다..
